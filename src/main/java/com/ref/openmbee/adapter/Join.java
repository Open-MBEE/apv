...
public class Join extends ControlNode implements IControlNode{

	public Join(String id, String type, String ownerId, String activityId, ArrayList<String> outgoingsIds,
