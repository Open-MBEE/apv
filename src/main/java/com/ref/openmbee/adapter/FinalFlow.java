...
public class FinalFlow extends ControlNode implements IControlNode{

	public FinalFlow(String id, String type, String ownerId, String activityId, ArrayList<String> outgoingsIds,
