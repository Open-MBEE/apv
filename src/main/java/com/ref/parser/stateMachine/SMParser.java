...
public class SMParser {
	...
	public String parserStateMachine() {
		...
		String result = channel + memory + state +  trans + entry + doString + exit + startSync;
		return result;
	}
	...
	public String defineStartSyncProcess() {
		SMUtils smu = defineSMUtils();
		dStartSync = new SMDefineStartSync(smu,sm,smDiagram,states,transitions,arrayTurn,arrayMemorySync);
